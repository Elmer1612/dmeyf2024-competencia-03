...
FEhist_base <- function( pinputexps)
{
  ...
  # Si me engraso las manos con las tendencias de segundo orden
...
wf_SEMI_SEPT_orden227 <- function( pnombrewf )
{
  ...
  ht <- HT_tuning_semillerio(
    ...
    bo_iteraciones = 25  # iteraciones inteligentes, reemplazo de 10 a 25
  )
